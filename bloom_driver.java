...
public class bloom_driver{
	...
	public static void main(String[] args) throws IOException {
		...
		toFile.println("kmer_size\ttestcase\tnormalize\t%+right\t%-right\t%avgright\t%hit\truntime\tpos_diff\tneg_diff");
		//for normalize and non-normal
		for(int norm = 0; norm < 2; norm++)
		{
			
		if(norm == 1) normalize = false;
		else if(norm == 0) normalize = true;
